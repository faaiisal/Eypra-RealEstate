...
const feature_data: DataType[] = [
   {
      ...
      title: "Buy a home",
      btn:"Find Home",
      desc: "Explore Epyra 2 million+ homes and uncover your ideal living space.",
   },
   {
      id: 2,
      page: "home_1_feature_1",
      ...
      title: "RENT A HOME",
      btn:"Rent Home",
      desc: "Discover a rental you'll love on Epyra, thanks to 35+ filters and tailored keywords.",
   },
   {
      id: 3,
      page: "home_1_feature_1",
